...
const VALID_FACTIONS = [
  'Empire', 'Dwarfs', 'Greenskins', 'Vampire Counts', 'Warriors of Chaos',
  'Beastmen', 'Wood Elves', 'Bretonnia', 'Norsca', 'High Elves', 'Dark Elves',
  'Lizardmen', 'Skaven', 'Tomb Kings', 'Vampire Coast', 'Kislev', 'Cathay',
  'Ogre Kingdoms', 'Daemons of Chaos Undivided', 'Khorne', 'Nurgle', 'Slaanesh',
  'Tzeentch', 'Chaos Dwarfs',
];
